# pefile-compatible ordinal->name tables for the special import libraries
# (ws2_32.dll, wsock32.dll, oleaut32.dll). imphash resolves ordinals imported from
# these to the real function name, as pefile / VirusTotal do; all other ordinal
# imports render "ord<N>". Generated from pefile 2024.8.26; names pre-lowercased.
# Parallels OffsetScan src/ordinals.rs. DO NOT EDIT BY HAND - regenerate from pefile.

$script:OISpecialOrdinals = @{
    'ws2_32.dll' = @{
        1 = 'accept'
        2 = 'bind'
        3 = 'closesocket'
...
function Get-OISpecialOrdinalName {
    # Resolve an ordinal imported from a special library to its lowercased function
    # name, matching pefile. Returns $null for non-special libraries or unlisted
    # ordinals, so the caller falls back to "ord<N>".
    [CmdletBinding()]
    param(
    ...
    $table = $script:OISpecialOrdinals[$Library.ToLowerInvariant()]
