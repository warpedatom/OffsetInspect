...
try {
    ...
    $expected = @('Add-OffsetDriftEntry', 'Compare-OffsetThreatResult', 'Export-OffsetThreatReport', 'Get-OffsetDetectionTrigger', 'Get-OffsetDrift', 'Get-OffsetEntropy', 'Get-OffsetIOC', 'Get-OffsetPEInfo', 'Get-OffsetSignature', 'Get-OffsetString', 'Invoke-OffsetClamScan', 'Invoke-OffsetInspect', 'Invoke-OffsetMutationTest', 'Invoke-OffsetThreatScan', 'Invoke-OffsetThreatScanBatch', 'Invoke-OffsetThreatScanRegion', 'Invoke-OffsetYaraScan')
